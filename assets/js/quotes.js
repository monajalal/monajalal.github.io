...
function getQuote() {
    $.ajax({
        headers: {
            "X-Mashape-Key": "X2tlZzRMXgmshEcS2jZqbjVhXIa9p1XwgXnjsnKvA5KaLkQLWH",
...
$(document).ready(function() {
    ...
    $('#facebook-quote').on('click', function() {
        if(!inIframe()) {
            openURL('https://www.facebook.com/widgets/share/tool?posttype=quote&tags=quotes,freecodecamp&caption='+encodeURIComponent(currentAuthor)+'&content=' + encodeURIComponent(currentQuote));
        }
    });
